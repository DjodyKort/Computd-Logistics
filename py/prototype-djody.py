...
X_train = scaler.fit_transform(train_df.drop(['Time Difference in Days'], axis=1))
Y_train = scaler.fit_transform(train_df['Time Difference in Days'].values.reshape(-1,1))

X_test = scaler.fit_transform(test_df.drop(['Time Difference in Days'], axis=1))
Y_test = scaler.fit_transform(test_df['Time Difference in Days'].values.reshape(-1,1))
